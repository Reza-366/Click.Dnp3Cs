...
//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatAck(ser4cpp.wseq_t buffer, bool aIsMaster, bool aIsRcvBuffFull, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
			return FormatHeader(buffer, 0, aIsMaster, false, aIsRcvBuffFull, LinkFunction.SEC_ACK, aDest, aSrc, pLogger);
		}

//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatNack(ser4cpp.wseq_t buffer, bool aIsMaster, bool aIsRcvBuffFull, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
			return FormatHeader(buffer, 0, aIsMaster, false, aIsRcvBuffFull, LinkFunction.SEC_NACK, aDest, aSrc, pLogger);
		}

//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatLinkStatus(ser4cpp.wseq_t buffer, bool aIsMaster, bool aIsRcvBuffFull, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
			return FormatHeader(buffer, 0, aIsMaster, false, aIsRcvBuffFull, LinkFunction.SEC_LINK_STATUS, aDest, aSrc, pLogger);
		}

//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatNotSupported(ser4cpp.wseq_t buffer, bool aIsMaster, bool aIsRcvBuffFull, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
			return FormatHeader(buffer, 0, aIsMaster, false, aIsRcvBuffFull, LinkFunction.SEC_NOT_SUPPORTED, aDest, aSrc, pLogger);
		}

//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatResetLinkStates(ser4cpp.wseq_t buffer, bool aIsMaster, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
			return FormatHeader(buffer, 0, aIsMaster, false, false, LinkFunction.PRI_RESET_LINK_STATES, aDest, aSrc, pLogger);
		}

//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatRequestLinkStatus(ser4cpp.wseq_t buffer, bool aIsMaster, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
			return FormatHeader(buffer, 0, aIsMaster, false, false, LinkFunction.PRI_REQUEST_LINK_STATUS, aDest, aSrc, pLogger);
		}

//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatTestLinkStatus(ser4cpp.wseq_t buffer, bool aIsMaster, bool aFcb, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
			return FormatHeader(buffer, 0, aIsMaster, aFcb, true, LinkFunction.PRI_TEST_LINK_STATES, aDest, aSrc, pLogger);
		}

//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatConfirmedUserData(ser4cpp.wseq_t buffer, bool aIsMaster, bool aFcb, UInt16 aDest, UInt16 aSrc, ser4cpp.rseq_t user_data, Logger pLogger)
		{
			...
			FormatHeader(buffer, (System.Byte)user_data.length(), aIsMaster, aFcb, true, LinkFunction.PRI_CONFIRMED_USER_DATA, aDest, aSrc, pLogger);
...
//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatUnconfirmedUserData(ser4cpp.wseq_t buffer, bool aIsMaster, UInt16 aDest, UInt16 aSrc, ser4cpp.rseq_t user_data, Logger pLogger)
		{
			if (user_data.length() > LPDU_MAX_USER_DATA_SIZE)
			{
				return ser4cpp.rseq_t.empty();
			...
			var userDataSize = CalcUserDataSize(user_data.length());
			var ret = buffer.@readonly().take(userDataSize + LPDU_HEADER_SIZE);
			FormatHeader(buffer, (System.Byte)user_data.length(), aIsMaster, false, false, LinkFunction.PRI_UNCONFIRMED_USER_DATA, aDest, aSrc, pLogger);
			WriteUserData(user_data, buffer, user_data.length());
			buffer.advance(userDataSize);
			return ret;
		}
...
//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public ser4cpp.rseq_t FormatHeader(ser4cpp.wseq_t buffer, System.Byte aDataLength, bool aIsMaster, bool aFcb, bool aFcvDfc, LinkFunction aFuncCode, UInt16 aDest, UInt16 aSrc, Logger pLogger)
		{
