...
//ORIGINAL LINE: virtual bool HasValue() const override
	...
	public override ser4cpp.rseq_t GetSegment()
	{
		...
		size_t numToSend = (this.message.payload.length() < opendnp3.Globals.MAX_TPDU_PAYLOAD) ? this.message.payload.length() : opendnp3.Globals.MAX_TPDU_PAYLOAD;
...
//ORIGINAL LINE: return statistics;
	...
	private System.UInt32 tpduCount = 0;
}
