...
{
	public APDURequest(in ser4cpp.wseq_t aBuffer) : base(aBuffer)
	{
	}

	public void ConfigureHeader(FunctionCode code, System.Byte seq)
	{
		this.SetFunction(FunctionCode.AUTH_REQUEST);
		this.SetControl(AppControlField.Request(new System.Byte(seq)));
	}
