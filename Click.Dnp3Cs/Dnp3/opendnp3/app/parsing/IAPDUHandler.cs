...
//ORIGINAL LINE: return errors;
	...
	// adhoc read by index
	public void OnHeader(in PrefixHeader header, in ICollection<UInt16> values)
	{
		Record(header, this.ProcessHeader(header, values));
	}
...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: System.UInt32 NumIgnoredHeaders() const
	protected System.UInt32 NumIgnoredHeaders()
	{
		return new System.UInt32(numIgnoredHeaders);
	}

	protected System.UInt32 GetCurrentHeader()
	{
		return new System.UInt32(numTotalHeaders);
	}
...
//ORIGINAL LINE: return ProcessUnsupportedHeader();
	...
	// adhoc read by index
	protected virtual IINField ProcessHeader(in PrefixHeader header, in ICollection<UInt16> values)
	{
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return ProcessUnsupportedHeader();
		return new opendnp3.IINField(ProcessUnsupportedHeader());
...
//ORIGINAL LINE: return ProcessUnsupportedHeader();
	...
	private System.UInt32 numTotalHeaders = new System.UInt32();
	private System.UInt32 numIgnoredHeaders = new System.UInt32();
}
