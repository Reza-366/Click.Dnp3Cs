...
{
	public BufferedCollection(in RSeq<size_t> buffer, size_t count, in ReadFunc readFunc)
	{
...
//ORIGINAL LINE: virtual size_t Count() const override final
	public override sealed size_t Count()
	{
...
//ORIGINAL LINE: virtual void Foreach(IVisitor<T>& visitor) const final
	public sealed override void Foreach(IVisitor<T> visitor)
	{
		...
		for (System.UInt32 pos = 0; pos < COUNT; ++pos)
		{
	...
	private readonly size_t COUNT = new size_t();
