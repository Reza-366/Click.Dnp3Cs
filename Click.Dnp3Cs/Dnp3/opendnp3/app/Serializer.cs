...
public class Serializer <T>
{
	...
	public delegate bool write_func_t(in T value, WSeq<size_t> buffer);

//C++ TO C# CONVERTER TASK: C# has no equivalent to ' = default':
//	Serializer() = default;

	public Serializer(size_t size, read_func_t read_func, write_func_t write_func)
	{
...
//ORIGINAL LINE: size_t get_size() const
...
//ORIGINAL LINE: bool read(RSeq<size_t>& buffer, T& output) const
	 ...
	 */
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: bool write(const T& value, WSeq<size_t>& buffer) const
	public bool write(in T value, WSeq<size_t> buffer)
	{
