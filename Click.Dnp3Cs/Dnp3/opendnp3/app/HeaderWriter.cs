...
//	friend class APDUWrapper;
	...
	public bool WriteHeader(GroupVariationID id, QualifierCode qc)
	{
		...
		ser4cpp.UInt8.write_to(position, new System.Byte(id.group));
		ser4cpp.UInt8.write_to(position, new System.Byte(id.variation));
...
//ORIGINAL LINE: size_t Remaining() const
	...
	private bool WriteHeaderWithReserve(GroupVariationID id, QualifierCode qc, size_t reserve)
	{
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
