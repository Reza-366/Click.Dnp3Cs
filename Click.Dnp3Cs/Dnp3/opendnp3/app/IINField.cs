...
public class IINField
{
	...
	private enum LSBMask : System.Byte
	{
		BROADCAST = 0x01,
		CLASS1_EVENTS = 0x02,
		CLASS2_EVENTS = 0x04,
	...
	private enum MSBMask : System.Byte
	{
	...
	public IINField(System.Byte aLSB, System.Byte aMSB)
	{
...
//ORIGINAL LINE: IINField operator ~() const
	...
	public System.Byte LSB = new System.Byte();
	public System.Byte MSB = new System.Byte();

	private const System.Byte REQUEST_ERROR_MASK = new System.Byte();

//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: inline bool Get(LSBMask bit) const
	private bool Get(LSBMask bit)
	{
		return (LSB & (System.Byte)bit) != 0;
	}
