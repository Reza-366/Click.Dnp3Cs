...
//ORIGINAL LINE: Flags GetFlags() const
	...
	{
		return new Flags(((System.Byte)value << 7) | (CommandStatusSpec.to_type(status)));
	}
...
//ORIGINAL LINE: bool operator ==(const BinaryCommandEvent& rhs) const
	...
	private const System.Byte ValueMask = 0x80;
	private const System.Byte StatusMask = 0x7F;
	...
	{
		return CommandStatusSpec.from_type(new System.Byte(flags.value & StatusMask));
	}
}
