...
{
	private static System.UInt32 max_hex_per_line = max_log_entry_size / 3;

	public static void log(Logger logger, LogLevel level, in RSeq<size_t> source, char separator = ' ', System.UInt32 first_row_size = max_hex_per_line, System.UInt32 other_row_size = max_hex_per_line)
	{
		RSeq<size_t> copy = new RSeq<size_t>(source);
		System.UInt32 row = 0;

		var max_first_size = ser4cpp.Globals.bounded<System.UInt32>(new System.UInt32(first_row_size), 1, new System.UInt32(max_hex_per_line));
		var max_other_size = ser4cpp.Globals.bounded<System.UInt32>(new System.UInt32(other_row_size), 1, new System.UInt32(max_hex_per_line));
...
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
	...
	private static RSeq<size_t> log_line(Logger logger, LogLevel level, in RSeq<size_t> data, char separator, System.UInt32 max_row_size)
	{
