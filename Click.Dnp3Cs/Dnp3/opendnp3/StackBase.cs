...
public class StackBase
{
	...
	protected StackBase(in Logger logger, ILinkListener listener, IOHandler iohandler, IResourceManager manager, System.UInt32 maxRxFragSize, in LinkLayerConfig config)
	{
