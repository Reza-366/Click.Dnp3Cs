...
//ORIGINAL LINE: output = TimeAndIntervalFactory::From(value.time, value.interval, value.units);
	  output = TimeAndIntervalFactory.From(new opendnp3.DNPTime(value.time), new System.UInt32(value.interval), new System.Byte(value.units));
	  return true;
	}
	else
	{
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group50Var1 UnnamedParameter2);
  public static bool Write(in Group50Var1 arg, WSeq<size_t> buffer)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group50Var3 UnnamedParameter2);
  public static bool Write(in Group50Var3 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.time);
  }
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group50Var4 UnnamedParameter2);
  public static bool Write(in Group50Var4 arg, WSeq<size_t> buffer)
  {
...
//  static bool ReadTarget(RSeq<size_t> UnnamedParameter, TimeAndInterval UnnamedParameter2);
  public static bool WriteTarget(in TimeAndInterval value, WSeq<size_t> buff)
  {
