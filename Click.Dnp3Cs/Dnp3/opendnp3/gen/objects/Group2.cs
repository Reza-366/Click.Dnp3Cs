...
public partial class Group2Var1
{
  ...
  public static bool Read(rseq_t buffer, Group2Var1 output)
  {
...
public partial class Group2Var2
{
  ...
  public static bool Read(rseq_t buffer, Group2Var2 output)
  {
...
//ORIGINAL LINE: output = BinaryFactory::From(value.flags, value.time);
	  output = BinaryFactory.From(new System.Byte(value.flags), new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
public partial class Group2Var3
{
  ...
  public static bool Read(rseq_t buffer, Group2Var3 output)
  {
	return LittleEndian.read(buffer, output.flags, output.time);
  }
...
//  static bool Write(in Group2Var3 UnnamedParameter, ser4cpp::wseq_t UnnamedParameter2);
  ...
  public static bool ReadTarget(rseq_t buff, ref Binary output)
  {
	...
	if (Read(buff, value))
	{
	  output = BinaryFactory.From(new System.Byte(value.flags), new UInt16(value.time));
	  return true;
	}
	else
	{
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group2Var1 UnnamedParameter2);
  public static bool Write(in Group2Var1 arg, WSeq<size_t> buffer)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group2Var2 UnnamedParameter2);
  public static bool Write(in Group2Var2 arg, WSeq<size_t> buffer)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group2Var3 UnnamedParameter2);
  public static bool Write(in Group2Var3 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.time);
  }
...
//  static bool ReadTarget(RSeq<size_t> UnnamedParameter, Binary UnnamedParameter2);
  public static bool WriteTarget(in Binary value, WSeq<size_t> buff)
  {
	return Group2Var3.Write(ConvertQTDowncast<Group2Var3, Binary, UInt16>.Apply(value), buff);
  }
