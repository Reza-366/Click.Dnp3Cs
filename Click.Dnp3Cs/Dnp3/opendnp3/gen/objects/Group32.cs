...
//ORIGINAL LINE: output = AnalogFactory::From(value.flags, value.value, value.time);
	  output = AnalogFactory.From(new System.Byte(value.flags), new int32_t(value.value), new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: output = AnalogFactory::From(value.flags, value.value, value.time);
	  output = AnalogFactory.From(new System.Byte(value.flags), new int16_t(value.value), new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: output = AnalogFactory::From(value.flags, value.value, value.time);
	  output = AnalogFactory.From(new System.Byte(value.flags), value.value, new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var1 UnnamedParameter2);
  public static bool Write(in Group32Var1 arg, WSeq<size_t> buffer)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var2 UnnamedParameter2);
  public static bool Write(in Group32Var2 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value);
  }
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var3 UnnamedParameter2);
  public static bool Write(in Group32Var3 arg, WSeq<size_t> buffer)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var4 UnnamedParameter2);
  public static bool Write(in Group32Var4 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value, arg.time);
  }
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var5 UnnamedParameter2);
  public static bool Write(in Group32Var5 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value);
  }
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var6 UnnamedParameter2);
  public static bool Write(in Group32Var6 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value);
  }
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var7 UnnamedParameter2);
  public static bool Write(in Group32Var7 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value, arg.time);
  }
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group32Var8 UnnamedParameter2);
  public static bool Write(in Group32Var8 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value, arg.time);
  }
