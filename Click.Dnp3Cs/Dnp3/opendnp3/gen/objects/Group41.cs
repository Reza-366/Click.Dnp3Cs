...
//  static bool Write(in Group41Var1 UnnamedParameter, ser4cpp::wseq_t UnnamedParameter2);
  ...
  public static bool ReadTarget(rseq_t buff, ref AnalogOutputInt32 output)
  {
	...
	if (Read(buff, value))
	{
	  output = AnalogOutputFactory<AnalogOutputInt32, int32_t>.From(new int32_t(value.value), new System.Byte(value.status));
	  return true;
	}
	else
	{
...
//  static bool Write(in Group41Var2 UnnamedParameter, ser4cpp::wseq_t UnnamedParameter2);
  ...
  public static bool ReadTarget(rseq_t buff, ref AnalogOutputInt16 output)
  {
	...
	if (Read(buff, value))
	{
	  output = AnalogOutputFactory<AnalogOutputInt16, int16_t>.From(new int16_t(value.value), new System.Byte(value.status));
	  return true;
	}
	else
	{
...
//  static bool Write(in Group41Var3 UnnamedParameter, ser4cpp::wseq_t UnnamedParameter2);
  ...
  public static bool ReadTarget(rseq_t buff, ref AnalogOutputFloat32 output)
  {
	...
	if (Read(buff, value))
	{
	  output = AnalogOutputFactory<AnalogOutputFloat32, float>.From(value.value, new System.Byte(value.status));
	  return true;
	}
	else
	{
...
//  static bool Write(in Group41Var4 UnnamedParameter, ser4cpp::wseq_t UnnamedParameter2);
  ...
  public static bool ReadTarget(rseq_t buff, ref AnalogOutputDouble64 output)
  {
	...
	if (Read(buff, value))
	{
	  output = AnalogOutputFactory<AnalogOutputDouble64, double>.From(value.value, new System.Byte(value.status));
	  return true;
	}
	else
	{
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group41Var1 UnnamedParameter2);
  public static bool Write(in Group41Var1 arg, WSeq<size_t> buffer)
  {
...
//  static bool ReadTarget(RSeq<size_t> UnnamedParameter, AnalogOutputInt32 UnnamedParameter2);
  public static bool WriteTarget(in AnalogOutputInt32 value, WSeq<size_t> buff)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group41Var2 UnnamedParameter2);
  public static bool Write(in Group41Var2 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.value, arg.status);
  }
...
//  static bool ReadTarget(RSeq<size_t> UnnamedParameter, AnalogOutputInt16 UnnamedParameter2);
  public static bool WriteTarget(in AnalogOutputInt16 value, WSeq<size_t> buff)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group41Var3 UnnamedParameter2);
  public static bool Write(in Group41Var3 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.value, arg.status);
  }
...
//  static bool ReadTarget(RSeq<size_t> UnnamedParameter, AnalogOutputFloat32 UnnamedParameter2);
  public static bool WriteTarget(in AnalogOutputFloat32 value, WSeq<size_t> buff)
  {
...
//  static bool Read(RSeq<size_t> UnnamedParameter, Group41Var4 UnnamedParameter2);
  public static bool Write(in Group41Var4 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.value, arg.status);
  }
...
//  static bool ReadTarget(RSeq<size_t> UnnamedParameter, AnalogOutputDouble64 UnnamedParameter2);
  public static bool WriteTarget(in AnalogOutputDouble64 value, WSeq<size_t> buff)
  {
