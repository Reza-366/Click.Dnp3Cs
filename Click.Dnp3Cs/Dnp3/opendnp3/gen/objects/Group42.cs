...
//ORIGINAL LINE: output = AnalogOutputStatusFactory::From(value.flags, value.value, value.time);
	  output = AnalogOutputStatusFactory.From(new System.Byte(value.flags), new int32_t(value.value), new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: output = AnalogOutputStatusFactory::From(value.flags, value.value, value.time);
	  output = AnalogOutputStatusFactory.From(new System.Byte(value.flags), new int16_t(value.value), new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: output = AnalogOutputStatusFactory::From(value.flags, value.value, value.time);
	  output = AnalogOutputStatusFactory.From(new System.Byte(value.flags), value.value, new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var1 UnnamedParameter2);
  public static bool Write(in Group42Var1 arg, WSeq<size_t> buffer)
  {
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var2 UnnamedParameter2);
  public static bool Write(in Group42Var2 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value);
  }
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var3 UnnamedParameter2);
  public static bool Write(in Group42Var3 arg, WSeq<size_t> buffer)
  {
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var4 UnnamedParameter2);
  public static bool Write(in Group42Var4 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value, arg.time);
  }
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var5 UnnamedParameter2);
  public static bool Write(in Group42Var5 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value);
  }
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var6 UnnamedParameter2);
  public static bool Write(in Group42Var6 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value);
  }
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var7 UnnamedParameter2);
  public static bool Write(in Group42Var7 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value, arg.time);
  }
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group42Var8 UnnamedParameter2);
  public static bool Write(in Group42Var8 arg, WSeq<size_t> buffer)
  {
	return LittleEndian.write(buffer, arg.flags, arg.value, arg.time);
  }
