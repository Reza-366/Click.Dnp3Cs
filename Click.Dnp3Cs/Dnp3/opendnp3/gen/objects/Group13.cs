...
//  static bool Write(in Group13Var1 UnnamedParameter, ser4cpp::wseq_t UnnamedParameter2);
  ...
  public static bool ReadTarget(rseq_t buff, ref BinaryCommandEvent output)
  {
	...
	if (Read(buff, value))
	{
	  output = BinaryCommandEventFactory.From(new System.Byte(value.flags));
	  return true;
	}
	else
	{
...
//ORIGINAL LINE: output = BinaryCommandEventFactory::From(value.flags, value.time);
	  output = BinaryCommandEventFactory.From(new System.Byte(value.flags), new opendnp3.DNPTime(value.time));
	  return true;
	}
	else
	{
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group13Var1 UnnamedParameter2);
  public static bool Write(in Group13Var1 arg, WSeq<size_t> buffer)
  {
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool ReadTarget(RSeq<size_t> UnnamedParameter, BinaryCommandEvent UnnamedParameter2);
  public static bool WriteTarget(in BinaryCommandEvent value, WSeq<size_t> buff)
  {
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//  static bool Read(RSeq<size_t> UnnamedParameter, Group13Var2 UnnamedParameter2);
  public static bool Write(in Group13Var2 arg, WSeq<size_t> buffer)
  {
