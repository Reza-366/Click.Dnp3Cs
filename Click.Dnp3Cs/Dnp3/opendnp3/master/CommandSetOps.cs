...
public sealed class CommandSetOps : IAPDUHandler, Uncopyable
{
	...
	public enum OperateResult : System.Byte
	{
		OK,
		FAIL_PARSE
	}

	public enum SelectResult : System.Byte
	{
		OK,
		FAIL_PARSE,
		FAIL_SELECT
...
//	static OperateResult ProcessOperateResponse(CommandSet set, in RSeq<size_t> headers, Logger logger);
	...
	private override bool IsAllowed(System.UInt32 headerCount, GroupVariation gv, QualifierCode qc)
	{
		switch (qc)
		{
