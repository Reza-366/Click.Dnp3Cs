 ...
 */
public class MasterTCPServer //final : public TCPServer
{
...
//        return server;
	...
	private IListenCallbacks callbacks;
	private ResourceManager manager;

	private static string SessionIdToString(uint64_t sessionid)
	{
	...
	private virtual void OnShutdown()
	{
	   // this->manager->Detach(this->shared_from_this());
	}

	private virtual void AcceptConnection(uint64_t sessionid)
	{
		//REZA Disabeled TCP For now
