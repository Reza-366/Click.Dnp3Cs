...
//ORIGINAL LINE: return stat;
	...
	public override IMasterScan AddRangeScan(GroupVariationID gvId, UInt16 start, UInt16 stop, TimeDuration period, ISOEHandler soe_handler, in TaskConfig config)
	{
	...
	public override void ScanRange(GroupVariationID gvId, UInt16 start, UInt16 stop, ISOEHandler soe_handler, in TaskConfig config)
	{
	...
	public override void Write(in TimeAndInterval value, UInt16 index, in TaskConfig config)
	{
	//    auto action
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//	sealed IMasterScan AddRangeScan(GroupVariationID gvId, UInt16 start, UInt16 stop, TimeDuration period, ISOEHandler soe_handler, in TaskConfig config);
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//	sealed void ScanRange(GroupVariationID gvId, UInt16 start, UInt16 stop, ISOEHandler soe_handler, in TaskConfig config);
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//	sealed void Write(in TimeAndInterval value, UInt16 index, in TaskConfig config);
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
