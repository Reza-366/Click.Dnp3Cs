...
//ORIGINAL LINE: last_timestamp = timestamp;
	...
	public override void RecordClassAssignment(AssignClassType type, PointClass clazz, UInt16 start, UInt16 stop)
	{
	}
...
//ORIGINAL LINE: virtual RestartMode WarmRestartSupport() const override
	...
	public override UInt16 ColdRestart()
	{
		return 65535;
	}
	public override UInt16 WarmRestart()
	{
		return 65535;
	}
