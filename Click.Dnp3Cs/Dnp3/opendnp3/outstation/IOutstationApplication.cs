...
public class IOutstationApplication : ILinkListener, IDnpTimeSource, System.IDisposable
{
	...
	public virtual void RecordClassAssignment(AssignClassType type, PointClass clazz, UInt16 start, UInt16 stop)
	{
	}
...
//ORIGINAL LINE: virtual RestartMode WarmRestartSupport() const
	...
	public virtual UInt16 ColdRestart()
	{
		return 65535;
	}
	...
	public virtual UInt16 WarmRestart()
	{
		return 65535;
	}
	...
	public virtual void OnConfirmProcessed(bool is_unsolicited, System.UInt32 num_class1, System.UInt32 num_class2, System.UInt32 num_class3)
	{
	}
