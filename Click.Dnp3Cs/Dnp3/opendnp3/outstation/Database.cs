...
//ORIGINAL LINE: return IINField::Empty();
	...
	public IINField SelectIndices(GroupVariation gv, in ICollection<UInt16> indices)
	{
		switch (gv)
		{
		case (GroupVariation.Group1Var0):
...
//ORIGINAL LINE: bool HasAnySelection() const override
	...
	// ------- IUpdateHandler ---------------
	public override bool Update(in Binary meas, UInt16 index, EventMode mode)
	{
		return this.binary_input.update(meas, index, mode, event_receiver);
	}

	public override bool Update(in DoubleBitBinary meas, UInt16 index, EventMode mode)
	{
		return this.double_binary.update(meas, index, mode, event_receiver);
	}

	public override bool Update(in Analog meas, UInt16 index, EventMode mode)
	{
		return this.analog_input.update(meas, index, mode, event_receiver);
	}

	public override bool Update(in Counter meas, UInt16 index, EventMode mode)
	{
		return this.counter.update(meas, index, mode, event_receiver);
	}

	public override bool FreezeCounter(UInt16 index, bool clear, EventMode mode)
	{
		var num_selected = this.counter.select(Range.From(new UInt16(index), new UInt16(index)));
		this.FreezeSelectedCounters(clear, mode);

		return num_selected > 0;
	}

	public override bool Update(in BinaryOutputStatus meas, UInt16 index, EventMode mode)
	{
		return this.binary_output_status.update(meas, index, mode, event_receiver);
	}

	public override bool Update(in AnalogOutputStatus meas, UInt16 index, EventMode mode)
	{
		return this.analog_output_status.update(meas, index, mode, event_receiver);
	}

	public override bool Update(in OctetString meas, UInt16 index, EventMode mode)
	{
	...
	public override bool Modify(FlagsType type, UInt16 start, UInt16 stop, System.Byte flags)
	{
		...
		case (FlagsType.BinaryInput):
			return this.binary_input.modify(new UInt16(start), new UInt16(stop), new System.Byte(flags), this.event_receiver);
		case (FlagsType.DoubleBinaryInput):
			return this.double_binary.modify(new UInt16(start), new UInt16(stop), new System.Byte(flags), this.event_receiver);
		case (FlagsType.AnalogInput):
			return this.analog_input.modify(new UInt16(start), new UInt16(stop), new System.Byte(flags), this.event_receiver);
		case (FlagsType.Counter):
			return this.counter.modify(new UInt16(start), new UInt16(stop), new System.Byte(flags), this.event_receiver);
		case (FlagsType.FrozenCounter):
			return this.frozen_counter.modify(new UInt16(start), new UInt16(stop), new System.Byte(flags), this.event_receiver);
		case (FlagsType.BinaryOutputStatus):
			return this.binary_output_status.modify(new UInt16(start), new UInt16(stop), new System.Byte(flags), this.event_receiver);
		case (FlagsType.AnalogOutputStatus):
			return this.analog_output_status.modify(new UInt16(start), new UInt16(stop), new System.Byte(flags), this.event_receiver);
		}
