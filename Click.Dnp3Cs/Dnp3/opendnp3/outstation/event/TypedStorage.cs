...
//ORIGINAL LINE: struct TypedStorage : private StaticOnly
public class TypedStorage <T> : StaticOnly
{

	public static Node<TypedEventRecord<T>> Retrieve(EventRecord record)
	{
