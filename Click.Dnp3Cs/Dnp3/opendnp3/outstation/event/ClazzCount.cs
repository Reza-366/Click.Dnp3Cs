...
//ORIGINAL LINE: System.UInt32 Get(EventClass clazz) const
	public System.UInt32 Get(EventClass clazz)
	{
		switch (clazz)
		{
		case (EventClass.EC1):
			return new System.UInt32(num_class_1);
		case (EventClass.EC2):
			return new System.UInt32(num_class_2);
			break;
		default:
			return new System.UInt32(num_class_3);
		}
	}
...
//ORIGINAL LINE: bool Any() const
	...
	private System.UInt32 num_class_1 = 0;
	private System.UInt32 num_class_2 = 0;
	private System.UInt32 num_class_3 = 0;
}
...
public class EventClassCounters
{
	...
	public System.UInt32 selected = 0;
