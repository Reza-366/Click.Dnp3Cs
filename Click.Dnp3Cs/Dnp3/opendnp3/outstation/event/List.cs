...
//C++ TO C# CONVERTER WARNING: The original C++ template specifier was replaced with a C# generic specifier, which may not produce the same behavior:
//ORIGINAL LINE: template<class U>
	public System.UInt32 RemoveAll<U>(in U match)
	{
...
//ORIGINAL LINE: current = iter.Next();
		...
		return new System.UInt32(count);
	}
...
//ORIGINAL LINE: bool IsFullAndCapacityNotZero() const
	...
	private ser4cpp.Array<Node<T>,list_size_type_t> underlying = new ser4cpp.Array<Node<T>,list_size_type_t>();
...
//ORIGINAL LINE: return new_node;
	...
	private void Initialize()
	{
		...
		for (System.UInt32 i = 1; i < underlying.length(); ++i)
		{
