...
public class EventWriting : StaticOnly
{
	...
	public static System.UInt32 Write(EventLists lists, IEventWriteHandler handler)
	{
		System.UInt32 total_num_written = 0;
		...
		while (true)
		{
			...
			if (num_written == 0)
			{
				return new System.UInt32(total_num_written);
			}
...
//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//	static UInt16 WriteSomeOfType<T>(event_iter_t iterator, EventLists lists, IEventWriteHandler handler);

//C++ TO C# CONVERTER TASK: The implementation of the following method could not be found:
//	static UInt16 WriteSome<T>(event_iter_t iterator, EventLists lists, IEventWriteHandler handler);
}
