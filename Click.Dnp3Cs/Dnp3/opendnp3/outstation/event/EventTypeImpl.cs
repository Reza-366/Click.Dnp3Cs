...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: virtual UInt16 WriteSome(List<EventRecord>::Iterator& iterator, EventLists& lists, IEventWriteHandler& handler) const override
	public override UInt16 WriteSome(List<EventRecord>.Iterator iterator, EventLists lists, IEventWriteHandler handler)
	{
