...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: virtual UInt16 WriteSome(List<EventRecord>::Iterator& iterator, EventLists& lists, IEventWriteHandler& handler) const = 0;
	public abstract UInt16 WriteSome(List<EventRecord>.Iterator iterator, EventLists lists, IEventWriteHandler handler);
