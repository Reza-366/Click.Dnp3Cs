...
//ORIGINAL LINE: return SelectMaxCount(gv, std::numeric_limits<System.UInt32>::max());
		return new opendnp3.IINField(SelectMaxCount(gv, System.UInt32.MaxValue));
	}

	public IINField SelectCount(GroupVariation gv, UInt16 count)
	{
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return SelectMaxCount(gv, count);
		return new opendnp3.IINField(SelectMaxCount(gv, new UInt16(count)));
	}
...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: System.UInt32 NumEvents(EventClass ec) const
	public System.UInt32 NumEvents(EventClass ec)
	{
		return new System.UInt32(this.storage.NumUnwritten(ec));
	}
	...
	private IINField SelectMaxCount(GroupVariation gv, System.UInt32 maximum)
	{
		switch (gv)
		{
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventType::Binary);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventType.Binary));
		case (GroupVariation.Group2Var1):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventBinaryVariation::Group2Var1);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventBinaryVariation.Group2Var1));
		case (GroupVariation.Group2Var2):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventBinaryVariation::Group2Var2);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventBinaryVariation.Group2Var2));
		case (GroupVariation.Group2Var3):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventBinaryVariation::Group2Var3);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventBinaryVariation.Group2Var3));

		case (GroupVariation.Group4Var0):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventType::DoubleBitBinary);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventType.DoubleBitBinary));
		case (GroupVariation.Group4Var1):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventDoubleBinaryVariation::Group4Var1);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventDoubleBinaryVariation.Group4Var1));
		case (GroupVariation.Group4Var2):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventDoubleBinaryVariation::Group4Var2);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventDoubleBinaryVariation.Group4Var2));
		case (GroupVariation.Group4Var3):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventDoubleBinaryVariation::Group4Var3);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventDoubleBinaryVariation.Group4Var3));

		case (GroupVariation.Group11Var0):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventType::BinaryOutputStatus);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventType.BinaryOutputStatus));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventBinaryOutputStatusVariation::Group11Var1);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventBinaryOutputStatusVariation.Group11Var1));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventBinaryOutputStatusVariation::Group11Var2);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventBinaryOutputStatusVariation.Group11Var2));

		case (GroupVariation.Group22Var0):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventType::Counter);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventType.Counter));
		case (GroupVariation.Group22Var1):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventCounterVariation::Group22Var1);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventCounterVariation.Group22Var1));
		case (GroupVariation.Group22Var2):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventCounterVariation::Group22Var2);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventCounterVariation.Group22Var2));
		case (GroupVariation.Group22Var5):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventCounterVariation::Group22Var5);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventCounterVariation.Group22Var5));
		case (GroupVariation.Group22Var6):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventCounterVariation::Group22Var6);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventCounterVariation.Group22Var6));

		case (GroupVariation.Group23Var0):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventType::FrozenCounter);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventType.FrozenCounter));
		case (GroupVariation.Group23Var1):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventFrozenCounterVariation::Group23Var1);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventFrozenCounterVariation.Group23Var1));
		case (GroupVariation.Group23Var2):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventFrozenCounterVariation::Group23Var2);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventFrozenCounterVariation.Group23Var2));
		case (GroupVariation.Group23Var5):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventFrozenCounterVariation::Group23Var5);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventFrozenCounterVariation.Group23Var5));
		case (GroupVariation.Group23Var6):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventFrozenCounterVariation::Group23Var6);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventFrozenCounterVariation.Group23Var6));

		case (GroupVariation.Group32Var0):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventType::Analog);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventType.Analog));
		case (GroupVariation.Group32Var1):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var1);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var1));
		case (GroupVariation.Group32Var2):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var2);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var2));
		case (GroupVariation.Group32Var3):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var3);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var3));
		case (GroupVariation.Group32Var4):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var4);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var4));
		case (GroupVariation.Group32Var5):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var5);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var5));
		case (GroupVariation.Group32Var6):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var6);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var6));
		case (GroupVariation.Group32Var7):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var7);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var7));
		case (GroupVariation.Group32Var8):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogVariation::Group32Var8);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogVariation.Group32Var8));

		case (GroupVariation.Group42Var0):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventType::AnalogOutputStatus);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventType.AnalogOutputStatus));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var1);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var1));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var2);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var2));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var3);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var3));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var4);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var4));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var5);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var5));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var6);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var6));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var7);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var7));
...
//ORIGINAL LINE: return this->SelectByType(maximum, EventAnalogOutputStatusVariation::Group42Var8);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventAnalogOutputStatusVariation.Group42Var8));

		case (GroupVariation.Group60Var2):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByClass(maximum, EventClass::EC1);
			return new opendnp3.IINField(this.SelectByClass(new System.UInt32(maximum), EventClass.EC1));
		case (GroupVariation.Group60Var3):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByClass(maximum, EventClass::EC2);
			return new opendnp3.IINField(this.SelectByClass(new System.UInt32(maximum), EventClass.EC2));
		case (GroupVariation.Group60Var4):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByClass(maximum, EventClass::EC3);
			return new opendnp3.IINField(this.SelectByClass(new System.UInt32(maximum), EventClass.EC3));

		case (GroupVariation.Group111Var0):
//C++ TO C# CONVERTER TASK: The following line was determined to contain a copy constructor call - this should be verified and a copy constructor should be created:
//ORIGINAL LINE: return this->SelectByType(maximum, EventOctetStringVariation::Group111Var0);
			return new opendnp3.IINField(this.SelectByType(new System.UInt32(maximum), EventOctetStringVariation.Group111Var0));
...
//ORIGINAL LINE: template<class T>
	private IINField SelectByType<T>(System.UInt32 max, T type)
	{
...
//ORIGINAL LINE: template<class T>
	...
	private IINField SelectByClass(System.UInt32 max, EventClass clazz)
	{
