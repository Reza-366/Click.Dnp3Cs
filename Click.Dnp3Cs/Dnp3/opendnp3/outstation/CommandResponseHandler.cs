...
{
	public CommandResponseHandler(System.UInt32 maxCommands_, ICommandAction pCommandAction_, HeaderWriter pWriter_)
	{
...
//ORIGINAL LINE: bool AllCommandsSuccessful() const
	...
	public override bool IsAllowed(System.UInt32 headerCount, GroupVariation gv, QualifierCode qc)
	{
...
//ORIGINAL LINE: return this->ProcessAny(header, meas);
	...
	{
		return this.RespondToHeader<ControlRelayOutputBlock, new ser4cpp.Globals.Bit16<UInt16, 0, 1>>(QualifierCode.UINT16_CNT_UINT16_INDEX, Group12Var1.Inst(), meas);
	}

	private IINField ProcessIndexPrefixTwoByte(in HeaderRecord record, in ICollection<Indexed<AnalogOutputInt16>> meas)
	{
		return this.RespondToHeader<AnalogOutputInt16, new ser4cpp.Globals.Bit16<UInt16, 0, 1>>(QualifierCode.UINT16_CNT_UINT16_INDEX, Group41Var2.Inst(), meas);
	}

	private IINField ProcessIndexPrefixTwoByte(in HeaderRecord record, in ICollection<Indexed<AnalogOutputInt32>> meas)
	{
		return this.RespondToHeader<AnalogOutputInt32, new ser4cpp.Globals.Bit16<UInt16, 0, 1>>(QualifierCode.UINT16_CNT_UINT16_INDEX, Group41Var1.Inst(), meas);
	}

	private IINField ProcessIndexPrefixTwoByte(in HeaderRecord record, in ICollection<Indexed<AnalogOutputFloat32>> meas)
	{
		return this.RespondToHeader<AnalogOutputFloat32, new ser4cpp.Globals.Bit16<UInt16, 0, 1>>(QualifierCode.UINT16_CNT_UINT16_INDEX, Group41Var3.Inst(), meas);
	}

	private IINField ProcessIndexPrefixTwoByte(in HeaderRecord record, in ICollection<Indexed<AnalogOutputDouble64>> meas)
	{
		return this.RespondToHeader<AnalogOutputDouble64, new ser4cpp.Globals.Bit16<UInt16, 0, 1>>(QualifierCode.UINT16_CNT_UINT16_INDEX, Group41Var4.Inst(), meas);
	}
	...
	private System.UInt32 numRequests = new System.UInt32();
	private System.UInt32 numSuccess = new System.UInt32();
	private readonly System.UInt32 maxCommands = new System.UInt32();
...
//ORIGINAL LINE: auto process = [this, pIterator, &ret](const Indexed<Target>& pair)
		var process = (in Indexed<Target> pair) =>
		{
			...
			response.status = this.ProcessCommand(pair.value, new UInt16(pair.index));
...
//ORIGINAL LINE: template<class Target>
	private CommandStatus ProcessCommand<Target>(in Target command, UInt16 index)
	{
