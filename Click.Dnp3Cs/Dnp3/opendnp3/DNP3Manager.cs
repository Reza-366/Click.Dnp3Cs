...
//C++ TO C# CONVERTER TASK: The following statement was not recognized, possibly due to an unrecognized macro:
	DNP3Manager(System.UInt32 concurrencyHint, opendnp3.ILogHandler * handler = , Action<System.UInt32> onThreadStart = null, Action<System.UInt32> onThreadExit = null); //  []void(System.UInt32) {});
