...
//	virtual ~ICommandHandler() = default;
	 ...
	 */
	public abstract CommandStatus Select(in ControlRelayOutputBlock command, ushort index);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Operate(in ControlRelayOutputBlock command, ushort index, IUpdateHandler handler, OperateType opType);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Select(in AnalogOutputInt16 command, ushort index);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Operate(in AnalogOutputInt16 command, ushort index, IUpdateHandler handler, OperateType opType);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Select(in AnalogOutputInt32 command, ushort index);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Operate(in AnalogOutputInt32 command, ushort index, IUpdateHandler handler, OperateType opType);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Select(in AnalogOutputFloat32 command, ushort index);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Operate(in AnalogOutputFloat32 command, ushort index, IUpdateHandler handler, OperateType opType);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Select(in AnalogOutputDouble64 command, ushort index);
	 ...
	 * @return result of request
	 */
	public abstract CommandStatus Operate(in AnalogOutputDouble64 command, ushort index, IUpdateHandler handler, OperateType opType);
}
