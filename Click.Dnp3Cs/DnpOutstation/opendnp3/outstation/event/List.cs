...
//ORIGINAL LINE: return ret;
	...
	//List(list_/*size_t*/intype_t maxSize) : ser4cpp::HasLength<list_/*size_t*/intype_t>(0), underlying(maxSize)
...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: inline list_/*size_t*/intype_t Capacity() const
...
//ORIGINAL LINE: bool IsFullAndCapacityNotZero() const
	...
	private ser4cpp.Array<Node<T>,list_/*size_t*/intype_t> underlying = new ser4cpp.Array<Node<T>,list_/*size_t*/intype_t>();
