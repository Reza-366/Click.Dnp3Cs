...
public sealed class CommandActionAdapter : ICommandAction
{
	...
	public override CommandStatus Action(in ControlRelayOutputBlock command, ushort index)
	{
		...
		return this.ActionT(command, new ushort(index));
	}

	public override CommandStatus Action(in AnalogOutputInt16 command, ushort index)
	{
		return this.ActionT(command, new ushort(index));
	}

	public override CommandStatus Action(in AnalogOutputInt32 command, ushort index)
	{
		return this.ActionT(command, new ushort(index));
	}

	public override CommandStatus Action(in AnalogOutputFloat32 command, ushort index)
	{
		return this.ActionT(command, new ushort(index));
	}

	public override CommandStatus Action(in AnalogOutputDouble64 command, ushort index)
	{
		return this.ActionT(command, new ushort(index));
	}
...
//ORIGINAL LINE: template<class T>
	private CommandStatus ActionT<T>(in T command, ushort index)
	{
		this.CheckStart();
