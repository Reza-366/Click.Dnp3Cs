...
public class BitfieldRangeWriteIterator <IndexType> : System.IDisposable
{
	...
	{
		var buffer = WSeq</*size_t*/int>.empty();
		return new BitfieldRangeWriteIterator(0, buffer);
	}

	public BitfieldRangeWriteIterator(IndexType.type_t start_, WSeq</*size_t*/int> position_)
	{
...
//ORIGINAL LINE: bool IsValid() const
	...
	private /*size_t*/int maxCount = new /*size_t*/int();

	private bool isValid;

	private WSeq</*size_t*/int> range = new WSeq</*size_t*/int>(); // make a copy to record where we write the range
	private WSeq</*size_t*/int> pPosition;
}
