...
//ORIGINAL LINE: template<class Target, class Source, byte Overrange> struct ConvertQVRangeCheck : private StaticOnly
//C++ TO C# CONVERTER WARNING: The original C++ template specifier was replaced with a C# generic specifier, which may not produce the same behavior:
//ORIGINAL LINE: template<class Target, class Source, typename Overrange> requires byte<Overrange>
//C++ TO C# CONVERTER TASK: C# has no concept of 'private' inheritance:
...
//C++ TO C# CONVERTER TASK: Most C++ 'constraints' are not converted by C++ to C# Converter:
//ORIGINAL LINE: template<class Target, class Source, byte Overrange> struct ConvertQVTRangeCheck : private StaticOnly
//C++ TO C# CONVERTER WARNING: The original C++ template specifier was replaced with a C# generic specifier, which may not produce the same behavior:
//ORIGINAL LINE: template<class Target, class Source, typename Overrange> requires byte<Overrange>
//C++ TO C# CONVERTER TASK: C# has no concept of 'private' inheritance:
