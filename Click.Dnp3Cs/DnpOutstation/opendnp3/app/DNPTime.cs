...
namespace opendnp3
{
    public class DNPTime
    {
        ...
        {
            this.value = 0;
            this.quality = opendnp3.TimestampQuality.INVALID;
        }
        public DNPTime(ulong value)
        {
            this.value = value;
            this.quality = opendnp3.TimestampQuality.SYNCHRONIZED;
        }
        public DNPTime(ulong value, TimestampQuality quality)
        {
            this.value = value;
