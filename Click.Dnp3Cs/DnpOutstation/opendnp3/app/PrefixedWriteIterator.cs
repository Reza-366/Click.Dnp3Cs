...
public class PrefixedWriteIterator <PrefixType, WriteType> : System.IDisposable
{
	...
	public PrefixedWriteIterator(in Serializer<WriteType> serializer, WSeq</*size_t*/int> position)
	{
...
//ORIGINAL LINE: bool IsValid() const
	...
	private /*size_t*/int sizeOfTypePlusIndex = new /*size_t*/int();

	private PrefixType.type_t count = new PrefixType.type_t();

	private bool isValid;

	private WSeq</*size_t*/int> countPosition = new WSeq</*size_t*/int>(); // make a copy to record where we write the count
