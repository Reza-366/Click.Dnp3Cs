...
public class AnalogOutputInt16 : AnalogOutput<Int16>
{
	...
	{
		this.AnalogOutput<Int16> = 0;
	}

	public AnalogOutputInt16(Int16 aValue)
	{
		this.AnalogOutput<Int16> = aValue;
	}

	public AnalogOutputInt16(Int16 aValue, CommandStatus aStatus)
	{
		this.AnalogOutput<Int16> = new <type missing>(aValue, aStatus);
	}
 ...
 */
public class AnalogOutputInt32 : AnalogOutput<int>
{
	public AnalogOutputInt32()
	{
		this.AnalogOutput<int> = 0;
	}

	public AnalogOutputInt32(int aValue)
	{
		this.AnalogOutput<int> = aValue;
	}

	public AnalogOutputInt32(int aValue, CommandStatus aStatus)
	{
		this.AnalogOutput<int> = new <type missing>(aValue, aStatus);
	}
