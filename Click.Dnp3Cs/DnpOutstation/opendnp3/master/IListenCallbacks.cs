...
public abstract class IListenCallbacks : System.IDisposable
{
	 ...
	 */
	public abstract bool AcceptConnection(ulong sessionid, in string ipaddress);
	 ...
	 */
	public abstract bool AcceptCertificate(ulong sessionid, in X509Info info);
	 ...
	 */
	public abstract void OnFirstFrame(ulong sessionid, in LinkHeaderFields header, ISessionAcceptor acceptor);
	 ...
	 */
	public abstract void OnConnectionClose(ulong sessionid, IMasterSession session);
	 ...
	 */
	public abstract void OnCertificateError(ulong sessionid, in X509Info info, int error);
}
