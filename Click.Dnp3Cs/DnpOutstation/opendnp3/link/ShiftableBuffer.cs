...
public class ShiftableBuffer
{
	 ...
	 */
	public ShiftableBuffer(byte pBuffer_, /*size_t*/int size)
	{
...
//ORIGINAL LINE: /*size_t*/int NumBytesRead() const
	public /*size_t*/int NumBytesRead()
	{
...
//ORIGINAL LINE: RSeq</*size_t*/int> ReadBuffer() const
	...
	public void AdvanceRead(/*size_t*/int numBytes)
	{
...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: /*size_t*/int NumWriteBytes() const
	public /*size_t*/int NumWriteBytes()
	{
...
//C++ TO C# CONVERTER WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: byte* WriteBuff() const
	...
	public void AdvanceWrite(/*size_t*/int aNumBytes)
	{
	...
	public bool Sync(/*size_t*/int skipCount)
	{
	...
	private readonly /*size_t*/int M_SIZE = new /*size_t*/int();
	private /*size_t*/int writePos = new /*size_t*/int();
	private /*size_t*/int readPos = new /*size_t*/int();
}
