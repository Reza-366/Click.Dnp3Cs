...
//	LinkConfig() = delete;
	...
	public LinkConfig(bool isMaster, ushort localAddr, ushort remoteAddr, TimeDuration timeout, TimeDuration keepAliveTimeout)
	{
...
//ORIGINAL LINE: inline Addresses GetAddresses() const
	...
	public ushort LocalAddr = new ushort();

	/// dnp3 address of the remote device
	public ushort RemoteAddr = new ushort();
