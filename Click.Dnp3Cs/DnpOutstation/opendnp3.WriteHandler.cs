...
//C++ TO C# CONVERTER WARNING: The original C++ declaration of the following method implementation was not found:
		public WriteHandler(IOutstationApplication application, TimeSyncState timeSyncState, SequenceNum<byte, 16> seq, Timestamp now, IINField writeIIN)
		{
			...
			this.seq = new opendnp3.SequenceNum<byte, 16>(seq);
